...
import com.totestmavenbuild_allserv.adventureworks2014.service.EmployeeDepartmentHistoryService;
...
public class EmployeeDepartmentHistoryController {
    ...
    @ApiOperation(value = "Returns the total count of EmployeeDepartmentHistory instances matching the optional query (q) request param.")
