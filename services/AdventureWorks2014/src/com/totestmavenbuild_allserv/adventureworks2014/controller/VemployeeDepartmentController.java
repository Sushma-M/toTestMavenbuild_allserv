...
import com.totestmavenbuild_allserv.adventureworks2014.VemployeeDepartment;
import com.totestmavenbuild_allserv.adventureworks2014.VemployeeDepartmentId;
import com.totestmavenbuild_allserv.adventureworks2014.service.VemployeeDepartmentService;
...
public class VemployeeDepartmentController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public VemployeeDepartment editVemployeeDepartment(@RequestParam(value = "businessEntityId", required = true) Integer businessEntityId, @RequestParam(value = "title", required = true) String title, @RequestParam(value = "firstName", required = true) String firstName, @RequestParam(value = "middleName", required = true) String middleName, @RequestParam(value = "lastName", required = true) String lastName, @RequestParam(value = "suffix", required = true) String suffix, @RequestParam(value = "jobTitle", required = true) String jobTitle, @RequestParam(value = "department", required = true) String department, @RequestParam(value = "groupName", required = true) String groupName, @RequestParam(value = "startDate", required = true) Date startDate, @RequestBody VemployeeDepartment vemployeeDepartment) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteVemployeeDepartment(@RequestParam(value = "businessEntityId", required = true) Integer businessEntityId, @RequestParam(value = "title", required = true) String title, @RequestParam(value = "firstName", required = true) String firstName, @RequestParam(value = "middleName", required = true) String middleName, @RequestParam(value = "lastName", required = true) String lastName, @RequestParam(value = "suffix", required = true) String suffix, @RequestParam(value = "jobTitle", required = true) String jobTitle, @RequestParam(value = "department", required = true) String department, @RequestParam(value = "groupName", required = true) String groupName, @RequestParam(value = "startDate", required = true) Date startDate) throws EntityNotFoundException {
        VemployeeDepartmentId vemployeedepartmentId = new VemployeeDepartmentId();
        vemployeedepartmentId.setBusinessEntityId(businessEntityId);
        vemployeedepartmentId.setTitle(title);
        vemployeedepartmentId.setFirstName(firstName);
    ...
    @ApiOperation(value = "Returns the total count of VemployeeDepartment instances matching the optional query (q) request param.")
