...
import com.totestmavenbuild_allserv.adventureworks2014.service.VjobCandidateEmploymentService;
...
public class VjobCandidateEmploymentController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public VjobCandidateEmployment editVjobCandidateEmployment(@RequestParam(value = "jobCandidateId", required = true) Integer jobCandidateId, @RequestParam(value = "emp_startDate", required = true) LocalDateTime emp_startDate, @RequestParam(value = "emp_endDate", required = true) LocalDateTime emp_endDate, @RequestParam(value = "emp_orgName", required = true) String emp_orgName, @RequestParam(value = "emp_jobTitle", required = true) String emp_jobTitle, @RequestParam(value = "emp_responsibility", required = true) String emp_responsibility, @RequestParam(value = "emp_functionCategory", required = true) String emp_functionCategory, @RequestParam(value = "emp_industryCategory", required = true) String emp_industryCategory, @RequestParam(value = "emp_loc_countryRegion", required = true) String emp_loc_countryRegion, @RequestParam(value = "emp_loc_state", required = true) String emp_loc_state, @RequestParam(value = "emp_loc_city", required = true) String emp_loc_city, @RequestBody VjobCandidateEmployment vjobCandidateEmployment) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteVjobCandidateEmployment(@RequestParam(value = "jobCandidateId", required = true) Integer jobCandidateId, @RequestParam(value = "emp_startDate", required = true) LocalDateTime emp_startDate, @RequestParam(value = "emp_endDate", required = true) LocalDateTime emp_endDate, @RequestParam(value = "emp_orgName", required = true) String emp_orgName, @RequestParam(value = "emp_jobTitle", required = true) String emp_jobTitle, @RequestParam(value = "emp_responsibility", required = true) String emp_responsibility, @RequestParam(value = "emp_functionCategory", required = true) String emp_functionCategory, @RequestParam(value = "emp_industryCategory", required = true) String emp_industryCategory, @RequestParam(value = "emp_loc_countryRegion", required = true) String emp_loc_countryRegion, @RequestParam(value = "emp_loc_state", required = true) String emp_loc_state, @RequestParam(value = "emp_loc_city", required = true) String emp_loc_city) throws EntityNotFoundException {
        VjobCandidateEmploymentId vjobcandidateemploymentId = new VjobCandidateEmploymentId();
        vjobcandidateemploymentId.setJobCandidateId(jobCandidateId);
        vjobcandidateemploymentId.setEmp_startDate(emp_startDate);
        vjobcandidateemploymentId.setEmp_endDate(emp_endDate);
    ...
    @ApiOperation(value = "Returns the total count of VjobCandidateEmployment instances matching the optional query (q) request param.")
